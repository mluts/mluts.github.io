...
var i_13910 = (0);
while(true){
if((i_13910 < arr.length)){
(arr[i_13910] = null);

var G__13912 = (i_13910 + (1));
i_13910 = G__13912;
continue;
} else {
}
...
var i_13923 = (self__.level + (1));
while(true){
if((i_13923 <= (new_level + (1)))){
(update[i_13923] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13925 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13925[i]));
} else {
x__$2.forward.push((((i < links_13925.length))?(links_13925[i]):null));
}

if((i < links_13925.length)){
(links_13925[i] = x__$2);
} else {
links_13925.push(x__$2);
}
...
var links_13932 = (update[i_13930]).forward;
if((x__$1 === (((i_13930 < links_13932.length))?(links_13932[i_13930]):null))){
(links_13932[i_13930] = (x__$1.forward[i_13930]));

var G__13934 = (i_13930 + (1));
i_13930 = G__13934;
continue;
} else {
var G__13935 = (i_13930 + (1));
i_13930 = G__13935;
continue;
}
} else {
