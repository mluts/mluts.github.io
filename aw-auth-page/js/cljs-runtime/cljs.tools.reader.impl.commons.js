...
var vec__21909 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21909,(0),null);
return (match === s);
});
...
var G__21926 = (i__5770__auto___21923 + (1));
i__5770__auto___21923 = G__21926;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq21916){
...
return (function() { 
var G__21930__delegate = function (rdr,_){
...
var G__21930 = function (rdr,var_args){
var _ = null;
...
while (G__21931__i < G__21931__a.length) {G__21931__a[G__21931__i] = arguments[G__21931__i + 1]; ++G__21931__i;}
  _ = new cljs.core.IndexedSeq(G__21931__a,0,null);
} 
return G__21930__delegate.call(this,rdr,_);};
G__21930.cljs$lang$maxFixedArity = 1;
G__21930.cljs$lang$applyTo = (function (arglist__21933){
var rdr = cljs.core.first(arglist__21933);
var _ = cljs.core.rest(arglist__21933);
return G__21930__delegate(rdr,_);
});
