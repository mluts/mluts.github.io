...
if((!((next_attr == null)))){
var G__26446 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(attrs,next_attr);
attrs = G__26446;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__26390){
var map__26392 = p__26390;
var map__26392__$1 = cljs.core.__destructure_map(map__26392);
var freeze_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26392__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
var freeze_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26392__$1,new cljs.core.Keyword(null,"freeze-kw","freeze-kw",391758233),datascript.serialize.freeze_kw);
...
var e = d.e;
var a = (function (){var G__26407 = d.a;
return (attrs_map.cljs$core$IFn$_invoke$arity$1 ? attrs_map.cljs$core$IFn$_invoke$arity$1(G__26407) : attrs_map.call(null,G__26407));
})();
var v = write_v(d.v);
...
var schema = (function (){var G__26411 = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db);
return (freeze_fn.cljs$core$IFn$_invoke$arity$1 ? freeze_fn.cljs$core$IFn$_invoke$arity$1(G__26411) : freeze_fn.call(null,G__26411));
})();
...
(datascript.serialize.from_serializable.cljs$core$IFn$_invoke$arity$2 = (function (from,p__26428){
var map__26429 = p__26428;
var map__26429__$1 = cljs.core.__destructure_map(map__26429);
var opts = map__26429__$1;
var thaw_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26429__$1,new cljs.core.Keyword(null,"thaw-fn","thaw-fn",-240544261),clojure.edn.read_string);
var thaw_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26429__$1,new cljs.core.Keyword(null,"thaw-kw","thaw-kw",1076733097),datascript.serialize.thaw_kw);
var tx0 = datascript.serialize.dict_get(from,"tx0");
var schema = (function (){var G__26430 = datascript.serialize.dict_get(from,"schema");
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__26430) : thaw_fn.call(null,G__26430));
})();
var _ = (function (){var fexpr__26432 = new cljs.core.Var(function(){return datascript.db.validate_schema;},new cljs.core.Symbol("datascript.db","validate-schema","datascript.db/validate-schema",-783030261,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"datascript.db","datascript.db",-444456104,null),new cljs.core.Symbol(null,"validate-schema","validate-schema",758884380,null),"datascript/db.cljc",23,1,928,928,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"schema","schema",58529736,null)], null)),null,(cljs.core.truth_(datascript.db.validate_schema)?datascript.db.validate_schema.cljs$lang$test:null)]));
return (fexpr__26432.cljs$core$IFn$_invoke$arity$1 ? fexpr__26432.cljs$core$IFn$_invoke$arity$1(schema) : fexpr__26432.call(null,schema));
})();
...
var pred__26437 = cljs.core._EQ__EQ_;
var expr__26438 = marker;
if(cljs.core.truth_((pred__26437.cljs$core$IFn$_invoke$arity$2 ? pred__26437.cljs$core$IFn$_invoke$arity$2((0),expr__26438) : pred__26437.call(null,(0),expr__26438)))){
...
var G__26440 = datascript.serialize.array_get(v,(1));
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__26440) : thaw_fn.call(null,G__26440));
} else {
...
if(cljs.core.truth_((pred__26437.cljs$core$IFn$_invoke$arity$2 ? pred__26437.cljs$core$IFn$_invoke$arity$2((3),expr__26438) : pred__26437.call(null,(3),expr__26438)))){
return -Infinity;
} else {
if(cljs.core.truth_((pred__26437.cljs$core$IFn$_invoke$arity$2 ? pred__26437.cljs$core$IFn$_invoke$arity$2((4),expr__26438) : pred__26437.call(null,(4),expr__26438)))){
return NaN;
} else {
...
var aevt = (function (){var G__26442 = datascript.serialize.dict_get(from,"aevt");
if((G__26442 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__26415_SHARP_){
return (eavt[p1__26415_SHARP_]);
}),G__26442);
}
})();
var avet = (function (){var G__26443 = datascript.serialize.dict_get(from,"avet");
if((G__26443 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__26416_SHARP_){
return (eavt[p1__26416_SHARP_]);
}),G__26443);
}
})();
var settings = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"branching-factor","branching-factor",1903198601),datascript.serialize.dict_get(from,"branching-factor"),new cljs.core.Keyword(null,"ref-type","ref-type",-1367328851),(function (){var G__26444 = datascript.serialize.dict_get(from,"ref-type");
if((G__26444 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__26444);
}
