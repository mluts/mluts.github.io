...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21838 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21838(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21839 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21839(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21840 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21840(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21841 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21841(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21842 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21842(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21843 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21843(reader);
}
});
...
var G__21862 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__21863 = s.append(c);
c = G__21862;
s = G__21863;
continue;
}
