...
("short"===this.ec.curve.type||"edwards"===this.ec.curve.type)&&assert(key.x&&key.y,"Need both x and y coordinate"),this.pub=this.ec.curve.point(key.x,key.y)):this.pub=this.ec.curve.decodePoint(key,enc)};KeyPair.prototype.derive=function(pub){pub.validate()||assert(pub.validate(),"public point not validated");return pub.mul(this.priv).getX()};KeyPair.prototype.sign=function(msg,enc,options){return this.ec.sign(msg,this,enc,options)};KeyPair.prototype.verify=function(msg,signature,options){return this.ec.verify(msg,
signature,this,void 0,options)};KeyPair.prototype.inspect=function(){return"\x3cKey priv: "+(this.priv&&this.priv.toString(16,2))+" pub: "+(this.pub&&this.pub.inspect())+" \x3e"}}
