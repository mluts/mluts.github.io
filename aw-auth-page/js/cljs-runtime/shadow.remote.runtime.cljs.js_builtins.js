...
var G__13098 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"message","message",-406056002),e__$1.message,new cljs.core.Keyword(null,"name","name",1843675177),e__$1.name,new cljs.core.Keyword(null,"stack","stack",-793405930),e__$1.stack], null);
var G__13098__$1 = (((!((data == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13098,new cljs.core.Keyword(null,"data","data",-232669377),data):G__13098);
var G__13098__$2 = (cljs.core.truth_(file)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13098__$1,new cljs.core.Keyword(null,"file","file",-1269645878),file):G__13098__$1);
var G__13098__$3 = (cljs.core.truth_(line)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13098__$2,new cljs.core.Keyword(null,"line","line",212345235),line):G__13098__$2);
if(cljs.core.truth_(column)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13098__$3,new cljs.core.Keyword(null,"column","column",2078222095),column);
} else {
return G__13098__$3;
}
}));
