...
var G__14684 = o;
reagent.impl.template.goog$module$goog$object.set(G__14684,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__14702__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__14702 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__14703__i = 0, G__14703__a = new Array(arguments.length -  0);
while (G__14703__i < G__14703__a.length) {G__14703__a[G__14703__i] = arguments[G__14703__i + 0]; ++G__14703__i;}
  args = new cljs.core.IndexedSeq(G__14703__a,0,null);
} 
return G__14702__delegate.call(this,args);};
G__14702.cljs$lang$maxFixedArity = 0;
G__14702.cljs$lang$applyTo = (function (arglist__14704){
var args = cljs.core.seq(arglist__14704);
return G__14702__delegate(args);
});
...
var G__14685 = o;
reagent.impl.template.goog$module$goog$object.set(G__14685,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__14706__i < G__14706__a.length) {G__14706__a[G__14706__i] = arguments[G__14706__i + 0]; ++G__14706__i;}
  args = new cljs.core.IndexedSeq(G__14706__a,0,null);
} 
...
var G__14686 = props;
var G__14686__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14686,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14686);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14686__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__14687 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14687,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__14687;
}
})(),id_class);
...
var G__14688 = (cljs.core.count(argv) - first_child);
switch (G__14688) {
case (0):
...
var vec__14689 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14689,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14689,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14689,(2),null);
...
var temp__5808__auto___14714 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___14714 == null)){
} else {
var key_14715 = temp__5808__auto___14714;
(jsprops.key = key_14715);
}
...
var temp__5808__auto___14717 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___14717 == null)){
} else {
var key_14718 = temp__5808__auto___14717;
(jsprops.key = key_14718);
}
...
var temp__5808__auto___14719 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___14719 == null)){
} else {
var key_14720 = temp__5808__auto___14719;
(jsprops.key = key_14720);
}
...
var temp__5808__auto___14721 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___14721 == null)){
} else {
var key_14722 = temp__5808__auto___14721;
(jsprops.key = key_14722);
}
...
var temp__5808__auto___14726 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___14726 == null)){
} else {
var key_14727 = temp__5808__auto___14726;
(jsprops.key = key_14727);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14692_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__14692_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__14693 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14693,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14693,(1),null);
...
break;
default:
var G__14729 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__14730 = compiler;
v = G__14729;
compiler = G__14730;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template14699 = (function (opts,id,fn_to_element,parse_fn,meta14700){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template14699.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14701,meta14700__$1){
var self__ = this;
var _14701__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template14699(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta14700__$1));
}));

(reagent.impl.template.t_reagent$impl$template14699.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14701){
var self__ = this;
var _14701__$1 = this;
return self__.meta14700;
}));

(reagent.impl.template.t_reagent$impl$template14699.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template14699.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template14699.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template14699.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template14699.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template14699.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta14700","meta14700",931289640,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template14699.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template14699.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template14699");

(reagent.impl.template.t_reagent$impl$template14699.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template14699");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template14699.
 */
reagent.impl.template.__GT_t_reagent$impl$template14699 = (function reagent$impl$template$__GT_t_reagent$impl$template14699(opts,id,fn_to_element,parse_fn,meta14700){
return (new reagent.impl.template.t_reagent$impl$template14699(opts,id,fn_to_element,parse_fn,meta14700));
});
...
return (new reagent.impl.template.t_reagent$impl$template14699(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
