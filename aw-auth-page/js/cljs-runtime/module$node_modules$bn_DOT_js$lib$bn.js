shadow$provide.module$node_modules$bn_DOT_js$lib$bn=function(global,require,module,exports){(function(module,exports){function assert(val,msg){if(!val)throw Error(msg||"Assertion failed");}function inherits(ctor,superCtor){ctor.super_=superCtor;var TempCtor=function(){};TempCtor.prototype=superCtor.prototype;ctor.prototype=new TempCtor;ctor.prototype.constructor=ctor}function BN(number,base,endian){if(BN.isBN(number))return number;this.negative=0;this.words=null;this.length=0;this.red=null;if(null!==
number){if("le"===base||"be"===base)endian=base,base=10;this._init(number||0,base||10,endian||"be")}}function parseHex4Bits(string,index){index=string.charCodeAt(index);if(48<=index&&57>=index)return index-48;if(65<=index&&70>=index)return index-55;if(97<=index&&102>=index)return index-87;assert(!1,"Invalid character in "+string)}function parseHexByte(string,lowerBound,index){var r=parseHex4Bits(string,index);index-1>=lowerBound&&(r|=parseHex4Bits(string,index-1)<<4);return r}function parseBase(str,
