...
bits)+1);var i;for(i=0;i<bits.length;i+=1)bits[i]=0;w=1<<w+1;num=num.clone();for(i=0;i<bits.length;i++){var z=num.andln(w-1);num.isOdd()?(z=z>(w>>1)-1?(w>>1)-z:z,num.isubn(z)):z=0;bits[i]=z;num.iushrn(1)}return bits};exports.getJSF=function(k1,k2){var jsf=[[],[]];k1=k1.clone();k2=k2.clone();for(var d1=0,d2=0,m8;0<k1.cmpn(-d1)||0<k2.cmpn(-d2);){var m14=k1.andln(3)+d1&3,m24=k2.andln(3)+d2&3;3===m14&&(m14=-1);3===m24&&(m24=-1);if(0===(m14&1))var u1=0;else m8=k1.andln(7)+d1&7,u1=3!==m8&&5!==m8||2!==m24?
