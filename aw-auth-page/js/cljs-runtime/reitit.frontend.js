...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__17470_SHARP_){
return reitit.frontend.query_param(q,p1__17470_SHARP_);
})),q.getKeys()));
});
/**
...
var new_query = ((cljs.core.fn_QMARK_(new_query_or_update_fn))?(function (){var G__17472 = reitit.frontend.query_params(uri);
return (new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1 ? new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1(G__17472) : new_query_or_update_fn.call(null,G__17472));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17479),"#",reitit.impl.form_encode(fragment)].join('');
} else {
return G__17479;
}
} else {
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__17485){
var map__17486 = p__17485;
var map__17486__$1 = cljs.core.__destructure_map(map__17486);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17486__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
var uri = goog.Uri.parse(path);
...
if(cljs.core.every_QMARK_((function (p1__17494_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__17494_SHARP_);
