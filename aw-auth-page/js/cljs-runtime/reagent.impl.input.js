...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__14662){
var map__14663 = p__14662;
var map__14663__$1 = cljs.core.__destructure_map(map__14663);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14663__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__14664 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__14665 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__14665);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__14664);
}}));
} else {
...
(jsprops.onChange = (function (p1__14672_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__14672_SHARP_);
}));
