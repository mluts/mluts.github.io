...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13060 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13060(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13066 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13066(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13075 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13075(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13078 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13078(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13081 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13081(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13084 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13084(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13043,callback){
var map__13044 = p__13043;
var map__13044__$1 = cljs.core.__destructure_map(map__13044);
var input = map__13044__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13044__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13044__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
